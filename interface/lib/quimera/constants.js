...
export const QUIMERA_DEFAULT_OPTIONS = {
  ...
  captureAllHosts: false, // informational mirror of the browser permission; never gates capture
  scopeHosts: [], // legacy permission/sync inventory; never gates capture
  collectors: {
    localStorage: true,
    sessionStorage: true,
    cookies: true,
...
export const MSG = {
  ...
  RETRY_DELIVERY: 'quimeraRetryDelivery', // background -> content after bridge settings change
  GET_OPTIONS: 'quimeraGetOptions',
  SET_OPTIONS: 'quimeraSetOptions',
  PING_BRIDGE: 'quimeraPingBridge',
  CHECK_BRIDGE_AUTH: 'quimeraCheckBridgeAuth',
